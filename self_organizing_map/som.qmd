...
This is exactly what self organizing maps can help us with!
Rather than having to make many plots to visualize the data, we can fit a map that can reduce our 4
